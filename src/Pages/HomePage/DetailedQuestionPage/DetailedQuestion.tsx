...
const options = [
  ["Strong - I enjoy guiding and motivating teams", "Moderate - I like managing projects but prefer not to lead",
     "Developing - I'd like to improve my leadership skills", "Minimal - I prefer being a team member rather than a leader"],
  ["Thinking outside the box and finding innovative solutions", "Breaking down complex technical issues",
     "Identifying needs and helping others", "Streamlining processes to make things more efficient"],
  ["Technology and innovation", "Arts, media, or entertainment", "Healthcare or education", "Business, finance, or entrepreneurship"],
  ["Becoming a creative director or leading visionary projects", "Gaining expertise as a senior engineer or technical expert", "Being a trusted mentor or advocate in my community",
     "Running my own business or leading a company"],
  ["Open, creative, and collaborative", "Structured with clear goal and innovation", "Mission-focused, emphasizing empathy and social impact", 
    "Competitive and performance-driven with a focus on growth"],
  ["By constantly brainstorming new ideas and designs", "By finding new ways to improve technical systems", "Through storytelling, writing, or teaching",
    "By developing innovative business strategies or marketing plans"],
  ["Visual arts, like design or photography", "Digital creation, like coding or interactive media", "Writing or speaking to convey ideas", 
    "Event planning, networking, or marketing campaigns"],
  ["I rely on creativity to explore different solutions", "I stay focused and methodical until the problem is solved", 
    "I seek advice from others and work collaboratively", "I take a strategic view and find the most efficient way to tackle it"],
  ["Freedom to be creative and express my ideas", "Mastery of skills and achieving technical issues", "Helping people and making a positive impact",
...
const DetailedQuestions = () => {
  ...
  const completedQuestions = answers.filter((answer) => answer.length > 0).length;
